...
namespace CottonOilFactory.OrderGUI.Database
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="CottonFactoryOrderInformation")]
    ...
    partial void DeleteSalesDatum(SalesDatum instance);
		...
		public DataClassesDataContext() : 
				base(global::CottonOilFactory.OrderGUI.Properties.Settings.Default.CottonFactoryOrderInformationConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class TransportationDatum : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _TransportationDatumID;
    ...
    partial void OnCreated();
    partial void OnTransportationDatumIDChanging(int value);
    partial void OnTransportationDatumIDChanged();
    ...
    partial void OnTotal_CostChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TransportationDatumID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int TransportationDatumID
		{
			get
			{
				return this._TransportationDatumID;
			}
			set
			{
				if ((this._TransportationDatumID != value))
				{
					this.OnTransportationDatumIDChanging(value);
					this.SendPropertyChanging();
					this._TransportationDatumID = value;
					this.SendPropertyChanged("TransportationDatumID");
					this.OnTransportationDatumIDChanged();
				}
			}
		}
