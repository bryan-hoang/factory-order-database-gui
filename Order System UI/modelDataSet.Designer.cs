...
namespace Order_System_UI.modelDataSetTableAdapters {
...
SELECT Id, [Name of Seller], [Truck Company], Quality, Weight, Price, [Number of Bags], [Freight Charges], [Shipment Number], [Date of Arrival], [Total Cost] FROM TransportationDataLog WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Order_System_UI.Properties.Settings.Default.modelConnectionString;
        }
        ...
        public virtual int Fill(modelDataSet.TransportationDataLogDataTable dataTable) {
        ...
        public virtual modelDataSet.TransportationDataLogDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            modelDataSet.TransportationDataLogDataTable dataTable = new modelDataSet.TransportationDataLogDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(modelDataSet.TransportationDataLogDataTable dataTable) {
